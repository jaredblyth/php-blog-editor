...
if (!is_administrator()) {
	print '<h2>Access Denied!</h2><p class="error" align="center">You do not have permission to access this page.</p>';
	exit();
}
?>
...
<form action="upload_file_mobile.php" enctype="multipart/form-data" method="post">
	<p>Upload a file:</p>
...
<p align="left"><a href="logout_mobile.php">Logout</a>
