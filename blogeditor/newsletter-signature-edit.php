...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
	...
	if ( !empty($_POST['entry']) && ($_POST['entry'] != 'Enter your text here.') ) { // Need some thing to write.
		...
		if (is_writable($file)) { // Confirm that the file is writable.
			...
			// Print a message:
			print '<p>Your newsletter signature has been stored.</p>';
...
<h3>Your current signature looks like this in HTML:</h3>

<?php include('newsletter-signature.php'); ?>

<br/><br/>

Edit your signature below:<br/><br/>

<form action="newsletter-signature-edit.php" method="post">
	<textarea name="entry" rows="5" cols="80"><?php include('newsletter-signature.php'); ?></textarea><script>CKEDITOR.replace( 'entry' );</script><br />
	<input type="submit" name="submit" value="Add As Signature!" />
</form>
